...
public class Regista {
	...
	public void addFilmTo(Film filmInstance) {
		this.films.add(filmInstance);
		filmInstance.setRegista(this);
	}

	public void removeFilmFrom(Film filmInstance) {
		this.films.remove(filmInstance);
		filmInstance.setRegista(null);
	}
}
